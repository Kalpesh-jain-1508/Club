...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a class="brand-link">
                <img src="{{ url('images/abclogo.jpeg') }}" alt="" height="60" width="90">
                <span class="brand-text font-weight-light"><b>The Clubies</b></span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="font-size: 120%">
                    <div class="image">
                        <img src="{{ url('https://media.licdn.com/dms/image/D4D03AQEHXTVJRidUOA/profile-displayphoto-shrink_800_800/0/1676834642010?e=2147483647&v=beta&t=WJPMUbKdoom-MCvmSjtUaa8SF8Hs2Av98rrxXpaDuc0') }}" class="img-circle" alt="">
                    </div>
                    <div class="info">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2022-2023 <a href="https://adminlte.io">Rohit</a>.</strong>
            All rights reserved.
