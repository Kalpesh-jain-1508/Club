              ...
              <form id="rcform" name="rcform" action="{{url('roomchargesupdate/'.$rc->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" value="{{$rc->photo1}}" name="photo1" class="form-control" id="photo1" placeholder="Choose Image" required>
                  </div>
                  <div class="form-group">
                    <label for="noofrooms">Photo : </label>
                    <input type="file" value="{{$rc->photo2}}" name="photo2" class="form-control" id="photo2" placeholder="Choose Image" required>
                  </div>
                  <div class="form-group">
                    <label for="noofrooms">Photo : </label>
                    <input type="file" value="{{$rc->photo3}}" name="photo3" class="form-control" id="photo3" placeholder="Choose Image" required>
                  </div>
                </div>
                <!-- /.card-body -->
