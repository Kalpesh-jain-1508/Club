                                                        ...
                                                        <tr>
                                                            ...
                                                            <div>
                                                                <img width="400" height="400"
                                                                    src="/storage/{{ $rc->photo1 }}" alt="Destination-img"
                                                                    style="align:left">
                                                                </a>
                                                                <br><br>
                                                                <div class="product-content">
                                                                    <b><a
                                                                            class="title">{{ session()->get('bktype') }}</a></b>
                                                                    <div class="product-info-wrap">
                                                                        <div class="product-info line-height-24">
                                                                            <span
                                                                                class="product-info-label">Reservation:</span>
                                                                            <span class="product-info-value">
                                                                                <span
                                                                                    class="product-check-in">{{ session()->get('bkcheckin') }}</span>
                                                                                <span class="product-mark">/</span>
                                                                                <span
                                                                                    class="product-check-out">{{ session()->get('bkcheckout') }}</span>
                                                                            </span>
                                                                        </div><!-- end product-info -->
                                                                        <div class="product-info line-height-24">
                                                                            <span class="product-info-label">Guests:</span>
                                                                            <span
                                                                                class="product-info-value">{{ session()->get('bkadults') }}</span>
                                                                        </div><!-- end product-info -->
                                                                        <div class="product-info line-height-24">
                                                                            <span class="product-info-label">Extra
                                                                                Services:</span>
                                                                            <span
                                                                                class="product-info-value">{{ session()->get('bkextrafacility') }}</span>
                                                                        </div><!-- end product-info -->
                                                                    </div>
                                                                </div>
                                                            </div>
