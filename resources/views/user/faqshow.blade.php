            ...
            <div class="carousel__item">
                <div class="ScrollStyle">
                    ...
                    <ul class="list-items list-items-flush">
                        <li><span class="text-black mr-2"><i class="la la-calendar mr-2 text-color font-size-18"></i>Keep
                                Social
                                Distancing</span></li>
                        <li><span class="text-black mr-2"><i class="la la-glass mr-2 text-color font-size-18"></i>Wear
                                Mask</span></li>
                        <li><span class="text-black mr-2"><i
                                    class="la la-laptop mr-2 text-color font-size-18"></i>Sanitizer</span></li>
                        <li><span class="text-black mr-2"><i class="la la-calendar mr-2 text-color font-size-18"></i>Members
                                Should Fully Vaccinated</span></li>
