            ...
            <!-- @foreach ($au as $item) -->
                    ...
                    <div class="col-lg-4 responsive-column">
                        <div class="card-item team-card">
                            <div class="card-img">
                                <img src="https://media.licdn.com/dms/image/D4D03AQEHXTVJRidUOA/profile-displayphoto-shrink_800_800/0/1676834642010?e=2147483647&v=beta&t=WJPMUbKdoom-MCvmSjtUaa8SF8Hs2Av98rrxXpaDuc0">
                            </div>
                            <div class="card-body">
                                <h3 class="card-title">ROHIT KUNGWANI</h3>
                                <p class="card-meta">TEST</p>
