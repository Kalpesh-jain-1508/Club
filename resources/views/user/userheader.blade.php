                    ...
                    <div class="col-lg-6">
                        <div class="header-top-content">
                            <div class="header-left">
                                <ul class="list-items">
                                    <li><i class="la la-phone mr-1"></i>+91 7600933084</li>
                                    <li><i class="la la-envelope mr-1"></i>rohitkungwani888@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="menu-wrapper">
                            ...
                            <div class="logo">
                                <img src="{{url('images/club.jpg')}}" height="80" width="100" alt="logo"></a>
                                {{-- <h4 style="font-display:initial color:blueviolet"><b>T</b>he <b>C</b>lubies</h4> --}}
                            ...
                            <div class="nav">
                                <div class="row">
                                    <div class="main-menu-content">
                                        ...
                                        @endif
                                        @if (session('membername'))
                                            <img class="img-circle" src="{{ url('images/dp.jpg') }}" height="40"
                                                width="40">
                                        @else
                                            <img class="img-circle" src="{{ url('images/userlogo.jpeg') }}" height="40"
                                                width="40">
                                        @endif
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="footer-item">
                        ...
                        <ul class="list-items pt-3">
                            <li>
                            Royal Trade Centre, 309, Pal Rd, Hazira, Adajan, Surat, Gujarat 395009
                            </li><br>
                            <li><b>Call us / WhatsApp us : </b></li>
                            <li>+91 7600933084</li><br>
                            <li><b>Mail us on : </b></li>
                            <li>rohitkungwani888@gmail.com</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 responsive-column">
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="list-items list--items">
                            <li><a href="https://www.facebook.com/"><i
                                        class="lab la-facebook-f"></i> Facebook</a></li><br>
                            <li><a href="https://www.instagram.com/rohit_kungwani"><i class="lab la-instagram"></i>
                                    Instagram</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="copy-right padding-top-30px">
                        <p class="copy__desc">
                            &copy; Copyright V2 Web Solutions 2023. Made with
                            <span class="la la-heart"></span> by <a
                                href="rohitkungwani.netlify.app">Rohit</a>
                        </p>
                    </div><!-- end copy-right -->
                </div><!-- end col-lg-7 -->
                <div class="col-lg-5">
